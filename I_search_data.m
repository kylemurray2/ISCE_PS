...
switch sat
    ...
    case 'ERS'
        ...
        if exist('intersect_point')
           ...
           apiCall='http://facility.unavco.org/SarArchive/SarScene?status=archived&format=CEOS,ENVISAT,GEOTIFF,HDF5,COSAR,UNSPECIFIED&firstResult=0&track=170&frame=2925&end=2000-01-01&maxResults=1000&intersectsWith=POINT(-117.88230895996523%2033.74232189197713)&beamSwath=STD&satellite=ERS1,ERS2' 
    ...
    case 'S1A'
        apiRoot       = 'http://facility.unavco.org/SarArchive/SarScene?status=archived';
