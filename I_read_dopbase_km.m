...
if(sum(goodid)<ndates)
    ...
    for i=1:ndates
        ...
        mysys(['use_rsc.pl ' dates(i).slc ' write DOPPLER_RANGE0 ' num2str(dop(3))]);
        mysys(['use_rsc.pl ' dates(i).slc ' write DOPPLER_RANGE1 ' num2str(dop(2))]);
        mysys(['use_rsc.pl ' dates(i).slc ' write DOPPLER_RANGE2 ' num2str(dop(1))]);
        mysys(['use_rsc.pl ' dates(i).slc ' write DOPPLER_RANGE3 0']);
        mysys(['use_rsc.pl ' dates(i).slc ' write SQUINT ' num2str(mean([dates.squint]))]);
        ...
        if(i~=id)
            ...
            mysys(['use_rsc.pl ' dates(i).slc ' write FILE_LENGTH ' num2str(ny+round(dates(i).azoff+minaz))]);
        else
            input(1).val = num2str(round(oldstart)-50);
            mysys(['use_rsc.pl ' dates(i).slc ' write FILE_LENGTH ' num2str(ny+round(minaz)-50)]);
